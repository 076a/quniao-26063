...
export class EditDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/EditDialog.ets(11:7)", "entry");
            Stack.height('100%');
            Stack.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Rect.create();
            Rect.debugLine("entry/src/main/ets/view/EditDialog.ets(12:9)", "entry");
            Rect.height('100%');
            Rect.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/EditDialog.ets(19:9)", "entry");
            Column.height('50%');
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/EditDialog.ets(20:11)", "entry");
            Column.height('80%');
            Column.padding(20);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextArea.debugLine("entry/src/main/ets/view/EditDialog.ets(21:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextArea.debugLine("entry/src/main/ets/view/EditDialog.ets(30:13)", "entry");
            TextArea.onChange((value: string) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/EditDialog.ets(42:11)", "entry");
            Row.margin({ top: '-80vp' });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/EditDialog.ets(43:13)", "entry");
            Button.onClick(() => {
                this.onClose();
            });
        }, Button);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/EditDialog.ets(47:13)", "entry");
            Button.onClick(() => {
                this.onSave();
            });
        }, Button);
