...
export class MainPage extends ViewPU {
    ...
    TabBuilder(title: Resource, index: number, selectedImg: Resource, parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            SymbolGlyph.debugLine("entry/src/main/ets/pages/MainPage.ets(35:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(title);
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(41:7)", "entry");
            Text.margin({ top: '4vp' });
            Text.fontSize(10);
            Text.fontWeight(500);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Tabs.debugLine("entry/src/main/ets/pages/MainPage.ets(59:7)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TabContent.tabBar({ builder: () => {
                            this.TabBuilder.call(this, { "id": 16777233, "type": 10003, params: [], "bundleName": "com.example.pageanddata", "moduleName": "entry" }, 0, { "id": 125831534, "type": 40000, params: [], "bundleName": "com.example.pageanddata", "moduleName": "entry" });
                        } });
                    TabContent.debugLine("entry/src/main/ets/pages/MainPage.ets(63:9)", "entry");
                }, TabContent);
                TabContent.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    TabContent.create(() => {
                    ...
                    TabContent.backgroundColor('#F1F3F5');
                    TabContent.tabBar({ builder: () => {
                            this.TabBuilder.call(this, { "id": 16777234, "type": 10003, params: [], "bundleName": "com.example.pageanddata", "moduleName": "entry" }, 1, { "id": 125831559, "type": 40000, params: [], "bundleName": "com.example.pageanddata", "moduleName": "entry" });
                        } });
                    TabContent.debugLine("entry/src/main/ets/pages/MainPage.ets(73:9)", "entry");
                }, TabContent);
                TabContent.pop();
                Tabs.pop();
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/MainPage.ets(58:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
